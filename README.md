...
Save [iMover jar](/brunohansen/iMove/releases/tag/v1.0.0) in eclipse plugins folder and restart it.
...
A copy of JDeodorant and JMove are available at [Tools](/brunohansen/iMove/tree/master/Tools) folder.
